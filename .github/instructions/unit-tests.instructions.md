...
- Comment only non-obvious test setup or domain constraints; do not annotate assertions by repeating what they assert.
- Keep test comments current when the behavior or fixture contract changes.
